...
export interface VideoData {
    ...
    description?: string;
    thumbnailUrl: string;
    videoUrl?: string; // currently unused but ready for real video parsing
}

interface VideoSliderUIProps {
    videos: VideoData[];
    sectionTheme?: "dark" | "light"; // optional prop to handle text colors
}

export default function VideoSliderUI({ videos, sectionTheme = "dark" }: VideoSliderUIProps) {
